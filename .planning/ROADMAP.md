...
- [x] 01-01-PLAN.md — CORS: `corsConfigurationSource` bean driven by `app.cors.allowed-origins` (empty default), with allow/reject/dev-flow tests (DEBT-02, GH #11)
...
|-------|----------------|--------|-----------|
| 1. Security & Deploy Hardening | 1/2 | In Progress|  |
